...
for i in range(1, 6):          # outer loop
    for j in range(1, i + 1):  # inner loop: prints numbers in the line
        print(j, end='')        
    print()                     
...
for i in range(1, 11):
    for j in range(1, 11):
        p = i * j
        print(f"{p:4d}", end="")  # inner loop prints numbers on same line
    print()  # outer loop moves to the next line
pass
